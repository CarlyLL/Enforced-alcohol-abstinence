...
It provides code for modelling binary reoffending outcomes as well as reoffending counts and the duration (in days) elapsed until any subsequence offence.
